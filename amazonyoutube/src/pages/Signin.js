        ...
        if (email && password) {
            ...
            signInWithEmailAndPassword(auth, email, password)
                .then((userCredential) => {
                    ...
                    // ...
                    setLoading(false)
                    setSuccessMsg("Logged in Successfully! Pleace wait a Little");
                    setTimeout(() => {
                        navigate("/");
                    }, 2000);
                })
            ...
            <div className='w-full bg-gray-100'>
                {successMsg ? (
                    ...
                    <form className='w-[350px] mx-auto flex flex-col items-center'>
                        <Link to="/"><img className='w-32' src={darkLogo} alt="darkLogoImg" /></Link>
                        <div className='w-full border border-zinc-200 p-6 ds'>
                            ...
                            <div>
                                ...
                                <button onClick={handleLogin} className='w-full py-1.5 text-sm font-normal rounded-sm bg-gradient-to-t from-[#f7dfa5] to-[#f0c14b] hover:bg-gradient-to-b border border-zinc-400 active:border-yellow-800 active:shadow-amazonInput mt-2'>Continue</button>
                                {loading && (
                            ...
                            <p className='text-xs text-black leading-4 mt-4'>
                                By Continuing, you agree to Amazon's <span className='text-blue-600 cursor-pointer hover:underline'>Conditions of Use{" "}</span> and <span className='text-blue-600 cursor-pointer hover:underline'>Privace Notice.</span></p>
                            <p className='text-sm text-gray-600 mt-4 cursor-pointer group'><ArrowRightIcon />
                        ...
                        <Link className='w-full' to="/registration">
                            <button className='w-full py-1.5 mt-4 mb-10 text-sm font-normal rounded-sm bg-gradient-to-t from-slate-200 to-slate-100 hover:bg-gradient-to-b border border-zinc-400 active:border-yellow-800 active:shadow-amazonInput'>
